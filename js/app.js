...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('btn-wt-skip').addEventListener('click', beginGame);
...
function onKeyDown(e) {
  ...
  if (!wrapper || wrapper.querySelector('.card-flip.flipped')) return;
